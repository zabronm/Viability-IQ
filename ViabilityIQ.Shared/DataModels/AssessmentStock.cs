...
{
    [Dapper.Contrib.Extensions.Table("tblAssessmentStock")]
    public class AssessmentStock : IEntity, IAuditableEntity, ISortableEntity
    {
        [Key] public long AssessmentStockId { get; set; }
        ...
        long IEntity.Id => AssessmentStockId;
