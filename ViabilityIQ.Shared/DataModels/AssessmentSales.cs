...
{
    [Dapper.Contrib.Extensions.Table("tblAssessmentSales")]
    public class AssessmentSales : IEntity, IAuditableEntity, ISortableEntity
    {
        ...
        long IEntity.Id => AssessmentSalesId;
