...
{
    public partial class FileUploadExtraComponent
    {
        // ==========================================
        // INJECTIONS
        // ==========================================
        ...
        private async Task SaveDocument()
        {
            ...
            var result = await documentService.UploadDocumentAsync(
                        ...
                        {
                            PhaseId = SelectedDocument.PhaseId,
                            ApplicationId = ApplicationId,
                            ApplicationDocumentId = 0,         //This is a new record, so primary key will noyt be propagated
